...
const ProjectItem = ({ title, focus, projectUrl, websiteUrl, description, website, status }) => {
    return (
        <div className='relative flex items-center justify-center h-auto w-full shadow-xl shadow-gray-400 rounded-xl group hover:bg-slate-100'>
            <section className="w-full p-5 space-y-3">
                ...
                {status === 'completed' ? <div className="flex justify-around">
                    {website == 'true' && <Link href={websiteUrl}><button
